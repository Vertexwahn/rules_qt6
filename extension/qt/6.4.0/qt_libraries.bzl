...
QT_LIBRARIES = [
    ...
    #]),
    # ("quick_3d_effects", "QtQuick3DEffects", "Qt6Quick3DEffects", [":qt_qml", ":qt_core"]),  # Not available in Qt 6.4.0
    ...
    # ("quick_particles", "Qt6QuickParticles", "Qt6QuickParticles", [":qt_quick", ":qt_qml", ":qt_gui", ":qt_core"]),  # Not available in Qt 6.4.0
