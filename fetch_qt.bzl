...
def fetch_qt6():
    ...
    http_archive(
        ...
        urls = [
            "https://vertexwahn.de/lfs/v1/qt_6.2.4_windows_desktop_win64_msvc2019_64.zip",
        ],
        sha256 = "926b528de8470f2f4217c49a9c9acb29d9b1e649d27e1c7d59885e389e69e325",
        strip_prefix = "6.2.4/msvc2019_64",
        build_file = "@rules_qt//:qt_6.2.4_windows_desktop_win64_msvc2019_64.BUILD",
    )

    # native.new_local_repository(
    #     name = "qt_6.2.4_windows_desktop_win64_msvc2019_64",
    #     path = "C:\\Qt\\6.3.2\\msvc2019_64",
    #     build_file = "@rules_qt//:qt_6.2.4_windows_desktop_win64_msvc2019_64.BUILD",
    # )
    ...
    native.new_local_repository(
        ...
        build_file = "@rules_qt//:qt_6.3.2_mac_desktop_clang_64_M1.BUILD",
    )
